<template>
  <div class="view res-width lightbox">
    <p class="exitbtn mr-auto mb-3 pt-2" @click.self="closeLightbox">&#8249;&#8249; Back to Sneakers</p>
...
export default {
  ...
  computed: {
    photo() {
      return this.sneakers.find((sneaker) => {
        return sneaker.id === Number(this.$route.params.id);
      });
    },
  },
  methods: {
